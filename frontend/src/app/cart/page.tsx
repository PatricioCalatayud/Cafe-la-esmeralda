...
const Cart = () => {
  ...
  // Variables agregadas
  const [invoiceType, setInvoiceType] = useState<string>(""); // Eliminamos needsInvoice
...
const handleCheckout = async (boton: string) => {
  ...
  const orderCheckout: any = {
    ...
    invoiceType, // Siempre incluir el tipo de factura
  };
            ...
            <Modal.Body className="flex flex-col gap-4">
              {loading === false ? (
                <>
                  ...
                  {/* Opciones de Tipo de Factura siempre visibles */}
                    ...
                    {(invoiceType === "B" || invoiceType === "C") && (
                      <div className="w-full h-20 gap-4 flex flex-col">
                        ...
                        <input
                          ...
                          disabled={!(invoiceType === "B" || invoiceType === "C")}
                        />
                      </div>
                    )}
                  </div>
                ...
                <div className="w-full">
                  <button
                    ...
                    disabled={
                      ...
                      !invoiceType || // Ya no verificamos needsInvoice
